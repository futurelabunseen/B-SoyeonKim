...
#include "WKAT_JumpAndWaitForLanding.generated.h"
 ...
 */
UCLASS()
class WARKING_API UWKAT_JumpAndWaitForLanding : public UAbilityTask
{
	GENERATED_BODY()
	
public:
	UWKAT_JumpAndWaitForLanding();
	...
	static UWKAT_JumpAndWaitForLanding* CreateTask(UGameplayAbility* OwningAbility);
